...
const Men: React.FC = () => {
  ...
  const menProducts = ALL_PRODUCTS.filter(product => 
    product.gender === 'men' || (product.gender === 'unisex' && product.category !== 'Accessories')
  );
      ...
      <main className="flex-grow pt-20">
        ...
        <section className="relative h-[70vh] w-full flex items-center justify-center border-b border-black">
          ...
          <div className="relative z-10 text-center text-white">
            ...
            <p className="text-xl max-w-2xl mx-auto leading-relaxed mb-8">
              Professional uniforms designed specifically for men across all industries
            </p>
            <Link 
              to="/catalog?filter=men"
        ...
        <section className="py-16 bg-zinc-50 border-b border-black">
          <div className="max-w-[1200px] mx-auto px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-3xl font-bold mb-2">Perfect Fit</div>
                <div className="text-[11px] font-bold tracking-widest uppercase text-zinc-500">Tailored Sizing</div>
              </div>
              <div>
                <div className="text-3xl font-bold mb-2">Premium</div>
                <div className="text-[11px] font-bold tracking-widest uppercase text-zinc-500">Quality Fabrics</div>
              </div>
              <div>
                <div className="text-3xl font-bold mb-2">Professional</div>
                <div className="text-[11px] font-bold tracking-widest uppercase text-zinc-500">Business Ready</div>
              </div>
              <div>
                <div className="text-3xl font-bold mb-2">Durable</div>
                <div className="text-[11px] font-bold tracking-widest uppercase text-zinc-500">Long Lasting</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 border-b border-black">
          <div className="max-w-[1400px] mx-auto px-8">
            <div className="text-center mb-16">
              <h2 className="font-heading text-5xl tracking-tight mb-6">MEN'S UNIFORM COLLECTION</h2>
              <p className="text-zinc-600 max-w-2xl mx-auto">
                From business suits to casual uniforms, our men's collection offers professional styling with superior comfort and durability.
              </p>
            </div>
        ...
        <section className="py-24 bg-black text-white">
          <div className="max-w-[1200px] mx-auto px-8 text-center">
            <h2 className="font-heading text-6xl tracking-tight mb-8">PROFESSIONAL MENSWEAR</h2>
            <p className="text-xl mb-12 max-w-2xl mx-auto">
              Discover our complete range of men's professional uniforms designed for the modern workplace
            </p>
